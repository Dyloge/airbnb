...
const Header = () => {
  return (
    <header>
      <div className=' grid gap-4 grid-cols-3 grid-rows-2  h-20  bg-black'>
        {/* logo */}
        ...
        {/* Host&Langs&SignIn */}
        <div>
          <ul className='flex justify-center text-slate-50 mt-7 text-xl'>
            <li>
              <button className=' font-bold hover:bg-zinc-900 rounded-full px-4 h-16 flex items-center justify-center mr-2'>
                Become a Host
              </button>
            </li>
            <li>
